...
import com.example.albalagha.setData
import kotlinx.android.synthetic.main.activity_quiz.*

class alnahwQuestion : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionList = setDataAlnahw.getQuestion()
        ...
        que4.setOnClickListener {
            selectedOptionStyle(que4, 4)
        }
    ...
    fun setColor(opt: Int, color: Int) {
        ...
        when (opt) {
            ...
            4 -> que4.background = ContextCompat.getDrawable(this, color)
    ...
    fun setQuestion() {
        ...
        que4.text = question.option_four
